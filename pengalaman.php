...
if (isset($_POST['submit'])) {
    ...
    $pengal = $_POST['pengal'];
    $email = $_POST['email'];
    if ($nama && $email && $pengal) {
        $sql = "INSERT INTO pengalaman (nama, email, pengal) VALUES ('$nama', '$email', '$pengal')";
...
<body>
    ...
    <div class="p-4 shadow-4 rounded-3" style="background-color: hsl(0, 0%, 94%);">
        <h2 class="text-center">BERBAGI PENGALAMAN WARGA</h2>
    </div>
    <!-- Jumbotron -->
    <!-- form -->
    <div class="container mt-3">
        <div class="card">
            <div class="card-body">
                ...
                <?php
                    header("refresh:1.5;url=pengalaman.php");
                }
                ?>
                <?php
                if ($gagal) {
                ...
                ?>
                <nav class="navbar mb-3 bg-primary">
                    &nbsp;&nbsp; Input Pengalaman
                </nav>
                <form method="post">
                    <!-- Name input -->
                    ...
                    <!-- Message input -->
                    <div class="form-outline mb-4">
                        <label class="form-label" for="form4Example3">Ceritakan Pengalaman Berkesan</label>
                        <textarea name="pengal" class="form-control" id="form4Example3" rows="4"></textarea>
