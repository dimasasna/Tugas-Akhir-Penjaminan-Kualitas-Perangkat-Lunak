...
<body>
    ...
    <div class="p-4 shadow-4 rounded-3" style="background-color: hsl(0, 0%, 94%);">
        ...
        <p class="text-center">Daftar pengalaman warga yang sudah mengisi di halaman warga</p>
    </div>
    <!-- Jumbotron -->
    <!-- Table -->
    <div class="container">
        <table class="table align-middle mb-0 bg-white">
            <thead class="bg-secondary text-light">
                ...
                echo "</tr>";
                echo "</thead>";
                $tampil = mysqli_query($conn, "SELECT * FROM pengalaman");
                foreach ($tampil as $row) {
                    ...
                    echo "</td>";
                    echo "<td>";
                    echo "<p class='fw-normal mb-1'>". $row['pengal'] ."</p>";
                    echo "</td>";
                    echo "</tr>";
                }
                ?>
